...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    mbToBeErased(false), mbBad(false), mHalfBaseline(F.mb/2), mpMap(pMap) ,mimDepthForPC(F.mimDepthForPC), mimRGBForPC(F.mimRGBForPC), mimDepthOriginal(F.mimDepthOriginal)
{
    mnId=nNextId++;
